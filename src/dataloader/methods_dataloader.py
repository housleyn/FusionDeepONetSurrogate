...
class MethodsDataloader:
    def get_dataloader(self, batch_size, shuffle=True, test_size=0.2, ddp=False, world_size=1, rank=0, num_workers=None):
        ...
        if ddp and dist.is_available() and dist.is_initialized():
            ...
            train_sampler = DistributedSampler(train_dataset, num_replicas=world_size, rank=rank, shuffle=shuffle, drop_last=False)

...
out_dir = Path("sandbox/spheres_single_case")
out_dir.mkdir(parents=True, exist_ok=True)

script_path = out_dir / "generate_single_spheres_input.py"
...
# Run the script to generate example outputs
ns = {}
exec(script, ns)
csv_path = out_dir / "generated_single_case.csv"
plot_path = out_dir / "generated_single_case_distance_plot.png"
df = ns["build_single_case"](
    x_secondary=2.747362847147431,
    y_secondary=0.8419290887304742,
    output_csv=csv_path,

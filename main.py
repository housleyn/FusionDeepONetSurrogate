...
if __name__ == "__main__":
    ...
    surrogate = Surrogate(config_path="configs/test2.yaml")
    # surrogate._train()
    # surrogate._infer_and_validate(file="Data/x_43_data_36/x_43_a21.8550107_a316.33293864_a410.25707196.csv", shape=None)
    ...
    # surrogate._infer_and_validate(file="Data/orion_data/orion_data_AoA0.61354843_Mach17.83834081.csv", shape=None)
